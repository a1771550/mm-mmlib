...
namespace MMLib.Models.Purchase
{
	public class PurchaseEditModel : PagingBaseModel
    {
        ...
        public void Get(long Id = 0, string receiptno = null, int? ireadonly = 0, string type = "", bool forprint = false)
        {
            MMDbContext context;
            Device device=null;
            bool isadmin = (bool)HttpContext.Current.Session["IsAdmin"];            
            get0(isadmin, out context, ref device);
        ...
        private void get0(bool isadmin, out MMDbContext context, ref Device device)
        {            
            Purchase = new PurchaseModel();
		...
		public static List<string> GetUploadPayBillSqlList(int accountprofileId, ref DataTransferModel dmodel, string strfrmdate, string strtodate, ComInfo comInfo, MMDbContext context)
		{
